      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(image: AssetImage(ImageConstant.imgBg10),
            fit: BoxFit.cover
            )
          ),
          child: Column(
                    ...
                    child: Row(
                      children: [
                        ...
                        CustomImageView(
                          ...
                          fit: BoxFit.fill,
                          width:
                              (MediaQuery.of(context).size.width - 130.h),
    ...
    return Row(
      ...
      children: [
        Container(
          height: 100.v,
          decoration: AppDecoration.outlineBlack.copyWith(
            image: DecorationImage(image: AssetImage("assets/images/radial_ray_blue.png",),fit: BoxFit.cover),
            borderRadius: BorderRadiusStyle.roundedBorder10
          ),
          child: Image(image: AssetImage("assets/images/clap_vector.png"),fit: BoxFit.cover),
        ),
        Container(
          height: 100.v,
          decoration: AppDecoration.outlineBlack.copyWith(
